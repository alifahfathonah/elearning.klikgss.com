...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'putradicky530@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Diki Putra'; // Isikan dengan nama pengirim
    protected $password = 'dickyroki'; // Isikan dengan password email pengirim
