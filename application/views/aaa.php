...
<body>
        ...
        -->
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li><a href="<?php echo base_url(); ?>adm/logout" onclick="return confirm('Apakah anda ingin keluar ?');">Logout</a></li>
            </ul>
          </li>
        </ul>
        <!--
  ...
  if ($sess_level == "guru") {
    $menu = array(
      ...
      array("icon" => "book", "url" => "m_materi", "text" => "Data Materi"),
      array("icon" => "list", "url" => "m_soal", "text" => "Soal"),
      array("icon" => "tasks", "url" => "m_ujian", "text" => "Ujian"),
    ...
    $menu = array(
      ...
      array("icon" => "book", "url" => "m_mapel", "text" => "Data Mapel"),
      array("icon" => "book", "url" => "m_materi", "text" => "Data Materi"),
      array("icon" => "th-list", "url" => "m_soal", "text" => "Soal"),
      array("icon" => "file", "url" => "h_ujian", "text" => "Hasil Ujian"),
      array("icon" => "envelope", "url" => "email", "text" => "Setting Email"),
    );
  } else {
    $menu = array(
      array("icon" => "dashboard", "url" => "", "text" => "Dashboard")
