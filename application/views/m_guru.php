                ...
                echo '<tr>
                      ...
                      <td class=""><center>
                        <div class="btn-group">
                          ...
                          <a href="#" onclick="return m_guru_matpel('.$d->id.');" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-th-list" style="margin-left: 0px; color: #fff"></i> &nbsp;&nbsp;Mata Pelajaran</a>
                          ';
                if ($d->ada == "0") {
          ...
          <form name="f_guru" id="f_guru" onsubmit="return m_guru_s();">
            <input type="hidden" name="id" id="id" value="0">
              <table class="table table-form">
                ...
                <tr>
                  <td style="width: 25%">Nip</td><td style="width: 75%"><input type="number" class="form-control" name="nip" id="nip" required></td>
                </tr>
                <tr>
                  <td style="width: 25%">Email</td><td style="width: 75%"><input type="text" class="form-control" name="email" id="email" required></td>
                </tr>
              </table>
      </div>
